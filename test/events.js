(function() {
  ...
  asyncTest("on and trigger", 2, function() {
    require(['underscore', 'Events'], function(_, Events){
      var obj = { counter: 0 };
      _.extend(obj, Events);
...
//
  asyncTest("binding and triggering with event maps", function() {
    require(['underscore', 'Events'], function (_, Events) {
      var obj = { counter: 0 };
      _.extend(obj, Events);
  ...
  asyncTest("stopListening cleans up references", 4, function() {
    require(['underscore', 'Events'], function (_, Events) {
      var a = _.extend({}, Events);
      var b = _.extend({}, Events);
      var fn = function() {};
  ...
  asyncTest("listenTo and stopListening cleaning up references", 2, function() {
    require(['underscore', 'Events'], function (_, Events) {
      var a = _.extend({}, Events);
      var b = _.extend({}, Events);
      a.listenTo(b, 'all', function(){ ok(true); });
...
//  asyncTest("Backbone object inherits Events", function() {
//    require(['underscore', 'Events'], function (_, Events) {
//      ok(Backbone.on === Events.on);
//
//      start();
//    });
//  });
